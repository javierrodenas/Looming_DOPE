...
categories = ['MainFace', 'LongLateralFace',' ShortLateralFace']
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            classes=categories,
            ann_file=
            '/home/javi/Downloads/cim_color/color/runs/labelme2coco/train.json',
            img_prefix='/home/javi/Downloads/cim_color/color/',
            pipeline=[
                dict(type='LoadImageFromFile'),
                dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
                dict(
    ...
    val=dict(
        ...
        classes=categories,
        ann_file=
        '/home/javi/Downloads/cim_color/color/runs/labelme2coco/val.json',
        img_prefix='/home/javi/Downloads/cim_color/color/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
