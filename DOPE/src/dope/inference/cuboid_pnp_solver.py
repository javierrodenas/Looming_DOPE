...
class CuboidPNPSolver(object):
    ...
    def solve_pnp(self, cuboid2d_points, pnp_algorithm = None):
        ...
        is_points_valid = valid_point_count >= 2
        print("eeeeeeeeeeee", valid_point_count)
        print(len(obj_3d_points), len(obj_2d_points))
        if is_points_valid:
            ...
            print("HOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOLAAA")
            print("aaaaaaaaaaaaaaaaaaaa", ret, rvec, tvec)
        ...
        print("outtt", location, quaternion, projected_points)
