...
"""
import sys
sys.path.append("/home/javier/Escritorio/Cube/DOPE-ROS-D435/dope/src/dope/inference/")
...
parser.add_argument('--datatest', 
    default="/home/javier/Escritorio/Cube/DOPE-ROS-D435/dope/scripts/Cube_test/", 
...
parser.add_argument('--net', 
    default='/home/javier/Escritorio/Cube/DOPE-ROS-D435/dope/scripts/train_cube_1214_with_object/soup_60.pth', 
...
def _runnetwork(epoch, loader, train=True):
    ...
    config_detect.treshold = 0.1
    config_detect.softmax = 500
    config_detect.thresh_angle = 0.1
    config_detect.thresh_map = 0.1
